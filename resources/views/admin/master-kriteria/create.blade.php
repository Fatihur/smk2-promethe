...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Form Tambah Master Kriteria</h3>
    </div>

    <form action="{{ route('admin.master-kriteria.store') }}" method="POST">
        @csrf
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                          ...
                          name="deskripsi" 
                          rows="3" 
                          placeholder="Masukkan deskripsi kriteria (opsional)">{{ old('deskripsi') }}</textarea>
                @error('deskripsi')
                    <span class="invalid-feedback">{{ $message }}</span>
                @enderror
            </div>
