...
@section('title', 'Proses Seleksi Kategori Khusus')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1>Proses Seleksi Kategori Khusus</h1>
        <div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Overview Kategori Khusus</h3>
                <div class="card-tools">
                    <div class="btn-group">
                        <a href="{{ route('admin.selection-process.khusus') }}" class="btn btn-primary btn-sm">
            ...
            <div class="card-body">
                <div class="alert alert-info">
                    ...
                    <strong>Kategori Khusus</strong> mencakup jurusan TAB (Teknik Audio Broadcasting) dan TSM (Teknik Sepeda Motor) 
                    yang memiliki kriteria seleksi khusus.
                </div>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="card card-outline card-warning">
                                    <div class="card-header">
                                        ...
                                        <div class="card-tools">
                                            <span class="badge badge-warning">{{ $stat['jurusan']->kode_jurusan }}</span>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                ...
                @else
                    <div class="text-center py-5">
                        ...
                        <h5 class="text-muted">Belum Ada Jurusan Kategori Khusus</h5>
                        <p class="text-muted">Silakan tambahkan jurusan dengan kategori khusus terlebih dahulu.</p>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Ringkasan Kategori Khusus</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3">
